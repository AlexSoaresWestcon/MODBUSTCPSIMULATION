...
Download the sample HMI project [**here**](https://raw.githubusercontent.com/AlexSoaresWestcon/MODBUSTCPSIMULATION/main/samples/HMI_Simulation_V2.vdz) (Right-click and save link as .vdz), unzip and import following the steps below:
